...
export function Trophy({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="M10 14.66V17c0 .55.47.98.97 1.21C12.04 18.75 14 20.24 14 22"></path>
...
export function Gamepad2({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      width="24"
...
export function Crown({ className }: { className?: string }) {
  return (
    <svg
      ...
      viewBox="0 0 24 24"
    >
      <path d="M2 4l3 12h14l3-12-6 7-4-7-4 7-6-7zm0 16h20"></path>
    </svg>
  )
}
